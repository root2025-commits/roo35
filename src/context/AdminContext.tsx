...
export function AdminProvider({ children }: { children: React.ReactNode }) {
  ...
  const updatePrices = (prices: PriceConfig) => {
    ...
    addNotification({
      ...
      message: `✅ Configuración actualizada: Películas $${prices.moviePrice} CUP, Series $${prices.seriesPrice} CUP/temporada, Transferencia ${prices.transferFeePercentage}%, Novelas $${prices.novelPricePerChapter} CUP/capítulo. Los cambios se han aplicado automáticamente en CheckoutModal.tsx, NovelasModal.tsx, PriceCard.tsx y CartContext.tsx`,
  ...
  const addDeliveryZone = (zone: Omit<DeliveryZone, 'id' | 'createdAt' | 'updatedAt'>) => {
    ...
    addNotification({
      ...
      message: `✅ Zona "${zone.name}" agregada con costo $${zone.cost} CUP. La zona se ha sincronizado automáticamente en CheckoutModal.tsx y está disponible inmediatamente para todos los nuevos pedidos`,
  ...
  const updateDeliveryZone = (zone: DeliveryZone) => {
    ...
    addNotification({
      ...
      message: `✅ Zona "${zone.name}" actualizada con nuevo costo $${zone.cost} CUP. Los cambios se han aplicado en tiempo real en CheckoutModal.tsx y están disponibles inmediatamente`,
      section: 'Zonas de Entrega',
      action: 'update'
    });
  ...
  const deleteDeliveryZone = (id: number) => {
    ...
    addNotification({
      ...
      message: `⚠️ Zona "${zone?.name || 'Desconocida'}" eliminada del sistema. Se ha removido automáticamente de CheckoutModal.tsx y ya no está disponible para nuevos pedidos`,
      section: 'Zonas de Entrega',
      action: 'delete'
    });
  ...
  const addNovel = (novel: Omit<Novel, 'id' | 'createdAt' | 'updatedAt'>) => {
    ...
    addNotification({
      ...
      message: `✅ Novela "${novel.titulo}" (${novel.año}) agregada exitosamente. Detalles: ${novel.capitulos} capítulos, género ${novel.genero}, costo $${novelCost.toLocaleString()} CUP. Se ha sincronizado automáticamente en NovelasModal.tsx`,
  ...
  const updateNovel = (novel: Novel) => {
    ...
    addNotification({
      ...
      message: `✅ Novela "${novel.titulo}" actualizada. Nuevos datos: ${novel.capitulos} capítulos, género ${novel.genero} (${novel.año}), costo actualizado $${novelCost.toLocaleString()} CUP. Los cambios se han aplicado en tiempo real en NovelasModal.tsx`,
      section: 'Gestión de Novelas',
      action: 'update'
    });
  ...
  const deleteNovel = (id: number) => {
    ...
    addNotification({
      ...
      message: `⚠️ Novela "${novel?.titulo || 'Desconocida'}" (${novel?.capitulos || 0} capítulos) eliminada del sistema. Se ha removido automáticamente del catálogo en NovelasModal.tsx`,
      section: 'Gestión de Novelas',
      action: 'delete'
    });
